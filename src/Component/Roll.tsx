...
const Rolling: React.FC = () => {
  ...
  const rollData: RollItem[] = [
    {
      id: 1,
      imageUrl: '/src/Pictures/RollPictures/1.png',
      alt: '图1',
      link: 'https://www.jxutcm.top'
    },
    {
      id: 2,
      imageUrl: '/src/Pictures/RollPictures/2.png',
      alt: '图2',
      link: 'https://www.jxutcm.top'
    },
    {
      id: 3,
      imageUrl: '/src/Pictures/RollPictures/3.png',
      alt: '图3',
      link: 'https://www.jxutcm.top'
    },
    {
      id: 4,
      imageUrl: '/src/Pictures/RollPictures/4.png',
      alt: '图4',
      link: 'https://www.jxutcm.top'
    },
    {
      id: 5,
      imageUrl: '/src/Pictures/RollPictures/5.png',
      alt: '图5',
      link: 'https://www.jxutcm.top'
    }
  ];
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-3 bg-black bg-opacity-30 px-2 py-1 rounded-full">
        {rollData.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentIndex ? 'bg-white' : 'bg-gray-400'
              }`}
          />
        ))}
      </div>
