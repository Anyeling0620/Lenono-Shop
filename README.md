...
- 使用 ESLint 进行代码规范检查，确保代码风格一致: 把鼠标停在错误代码处，ESLint会给你错误提示
...
#### 2.6 环境变量规范
- 环境变量以VITE开头，全大写字母，单词之间以_分隔,用=赋值，不能有空格，如VITE_API_URL=https://api.example.com
- 环境变量文件以.env开头，如.env.development,这是开发环境的环境变量文件，.env.production是生产环境的环境变量文件
- 环境变量文件中不能有注释
